			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/soal/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url(" admin/soal/edit") ?>" method="post"
							enctype="multipart/form-data" >

							<input type="hidden" name="id" value="<?php echo $tbl_soal->id_soal?>" />

							<div class="form-group">
								<label for="name">Id Mata Pelajaran*</label>
								<input class="form-control <?php echo form_error('id_mapel') ? 'is-invalid':'' ?>"
								 type="text" name="id_mapel" placeholder="Masukkan Id mapel" value="<?php echo $tbl_soal->id_mapel ?>"/>
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('pertanyaan') ? 'is-invalid':'' ?>"
								 name="pertanyaan" placeholder="Masukkan pertanyaan..."><?php echo $tbl_soal->pertanyaan ?></textarea>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('pilihan_a') ? 'is-invalid':'' ?>"
								 type="text" name="pilihan_a" placeholder="Masukkan pilihan_a" value="<?php echo $tbl_soal->pilihan_a ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('pilihan_b') ? 'is-invalid':'' ?>"
								 type="text" name="pilihan_b" placeholder="Masukkan pilihan_b" value="<?php echo $tbl_soal->pilihan_b ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('pilihan_c') ? 'is-invalid':'' ?>"
								 type="text" name="pilihan_c" placeholder="Masukkan pilihan_c" value="<?php echo $tbl_soal->pilihan_c ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('pilihan_d') ? 'is-invalid':'' ?>"
								 type="text" name="pilihan_d" placeholder="Masukkan pilihan_d" value="<?php echo $tbl_soal->pilihan_d ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('skor_a') ? 'is-invalid':'' ?>"
								 type="number" name="skor_a" min="0" placeholder="Masukkan Skor A" value="<?php echo $tbl_soal->skor_a ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('skor_b') ? 'is-invalid':'' ?>"
								 type="number" name="skor_b" min="0" placeholder="Masukkan Skor B" value="<?php echo $tbl_soal->skor_b ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('skor_c') ? 'is-invalid':'' ?>"
								 type="number" name="skor_c" min="0" placeholder="Masukkan Skor C" value="<?php echo $tbl_soal->skor_c ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('skor_d') ? 'is-invalid':'' ?>"
								 type="number" name="skor_d" min="0" placeholder="Masukkan Skor D" value="<?php echo $tbl_soal->skor_d ?>" />
								<div class="invalid-feedback">
									<?php echo form_error('skor_d') ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('kunci') ? 'is-invalid':'' ?>"
								 type="text" name="kunci" placeholder="Masukkan Kunci Jawaban" value="<?php echo $tbl_soal->kunci ?>" />
								<div class="invalid-feedback">
